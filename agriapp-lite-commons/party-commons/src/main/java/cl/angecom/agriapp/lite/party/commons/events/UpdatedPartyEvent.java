...
import cl.angecom.agriapp.lite.party.commons.commands.UpdatePartyCommand;

public class UpdatedPartyEvent {	
	...
	public UpdatedPartyEvent(){}
	
	public UpdatedPartyEvent(UpdatePartyCommand command){
